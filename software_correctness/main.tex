...
\begin{frame}
    \begin{block}{Disclaimer 1}
        Many simplifications are made to make this presentation digestible.
    \end{block}
    ...
    \end{block}
    \note[item]{Used to be Polish, but the amount of jargon made switching between Polish/English awkward}
